const fallbackCategories = [
  { id: '1', name: 'Vat-Dyed Fabrics', description: 'Molecular-level color integrity with 24-hour freshness shield', startingPrice: 380, clothing: 'Suiting', active: true },
  { id: '2', name: 'Fiber-Dyed Fabrics', description: 'Advanced fiber-dyeing technology with superior color fastness', startingPrice: 420, clothing: 'Suiting', active: true },
  { id: '3', name: 'Wollen Fabrics', description: 'High-quality woolen fabric with excellent thermal properties', startingPrice: 320, clothing: 'Suiting', active: true },
  { id: '4', name: 'Hosiery Fabrics', description: 'Premium hosiery fabric with superior elasticity and comfort', startingPrice: 280, clothing: 'Shirting', active: true },
  { id: '5', name: 'Cotton Fabrics', description: 'Premium cotton fabric with natural breathability and comfort', startingPrice: 180, clothing: 'Shirting', active: true }
];

const fallbackProducts = [
  { id: '1', code: 'VD-001', name: 'Vat-Dyed Premium Fabric', categoryId: '1', description: 'Molecular-level color integrity with 24-hour freshness shield. Perfect for high-end uniform applications.', priceType: 'Price', startingPrice: 380, priceMin: 0, priceMax: 0, priceUnit: 'm', clothing: 'Suiting', gsm: 240, blend: '65% Polyester, 35% Viscose', weave: 'Twill / Ripstop', premium: true, image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=1000', active: true },
  { id: '2', code: 'FD-001', name: 'Fiber-Dyed Advanced Fabric', categoryId: '2', description: 'Advanced fiber-dyeing technology with superior color fastness and durability.', priceType: 'Price', startingPrice: 420, priceMin: 0, priceMax: 0, priceUnit: 'm', clothing: 'Suiting', gsm: 285, blend: '80% Polyester, 20% Viscose', weave: 'Poly-Viscose', premium: true, image: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=1000', active: true },
  { id: '3', code: 'WL-001', name: 'Premium Wollen Fabric', categoryId: '3', description: 'Thermal comfort and formal finish for winter uniforms and corporate wear.', priceType: 'Range', startingPrice: 0, priceMin: 320, priceMax: 360, priceUnit: 'm', clothing: 'Suiting', gsm: 320, blend: '70% Wool, 30% Polyester', weave: 'Wool Blend', premium: false, image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=1000', active: true },
  { id: '4', code: 'HS-001', name: 'Premium Hosiery Fabric', categoryId: '4', description: 'Elastic, breathable hosiery fabric suited for medical and hospitality applications.', priceType: 'Price', startingPrice: 280, priceMin: 0, priceMax: 0, priceUnit: 'm', clothing: 'Shirting', gsm: 210, blend: '95% Cotton, 5% Spandex', weave: 'Knitted', premium: false, image: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=1000', active: true },
  { id: '5', code: 'CT-001', name: 'Premium Cotton Fabric', categoryId: '5', description: 'Natural breathability and soft hand-feel for daily uniforms and casual workwear.', priceType: 'Range', startingPrice: 0, priceMin: 180, priceMax: 220, priceUnit: 'm', clothing: 'Shirting', gsm: 180, blend: '100% Cotton', weave: 'Cotton Twill', premium: false, image: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=1000', active: true }
];
